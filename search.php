...
get_header(); ?>
  ...
  <div class="search_form">
		<form method="get" id="searchform" action="<?php bloginfo('url'); ?>">
			<div>
			<input class="text-buttonsearch" type="text" value=" " name="s" id="buttonsearch" placeholder="Search..."/>
			<input type="submit" class="submit buttonsearch" name="submit" value="<?php _e('Search');?>" />
			</div>
			</form>
		</div>
