...
<body>
	...
	<section id="description">
		<div class="description_container">
			<div class="rows description_rows">
				<div class="description_column text-center">
					<div class="description">
						<h2 class="description_heading"> <?php printf( get_theme_mod( 'second_section_heading', __( 'With Great Community', 'second_section_heading' ) ) ); ?> </h2>
	   ...
	   <div class="container latest_events_container">
		   <div class="rows latest_events_rows">
			   <div class="latest_events_column ">
					...
					<div class="latest_events_col">
						<hr class="divider">
							<h2 class="latest_events_heading"> <?php printf( get_theme_mod( 'heading', __( 'Latest Events', 'heading' ) ) ); ?> </h2>
   ...
   <section id="fourth_section">
	   <div class="fourth_section_container">
		   <div class="rows fourth_section_rows">
			   <div class="fourth_section_column ">
					<div class="fourth_section_col">
						<hr class="divider divider--red">

						<h2 class="fourth_section_heading"> <?php printf( get_theme_mod( 'fourth_heading', __( 'We are One', 'fourth_heading' ) ) ); ?> </h2>
						
						<p class="fourth_section_paragraph">
						<?php
							printf(
								get_theme_mod(
									'fourth_paragraph',
	...
	Sed malesuada, leo posuere rutrum viverra.',
										'fourth_paragraph'
									)
								)
							);
					...
					<div class="fourth_section_col">
						<img class="image-last" src="<?php echo get_theme_mod( 'fourth_image', get_bloginfo( 'template_directory' ) . '/assets/images/Temp3_WeAreOne.png' ); ?>" border="0" alt="map">
				 	</div>
				</div>
			</div>
	   </div>
